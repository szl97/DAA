...
**算法**：图像增强 + HSV/LAB 蓝光分割 + 形态学去噪 + 车辆目标检测 + 蓝光-车辆空间关联 + 干扰过滤。
...
python main.py --input input/highway.mp4 --output output/result.mp4
```
...
- `output/result.jpg` / `output/result.mp4`：检测可视化结果；
